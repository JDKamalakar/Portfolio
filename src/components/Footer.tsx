  ...
  return (
    <div className="bg-gray-900 dark:bg-black py-12 px-6 relative">
      ...
      >
        ...
        <div className="absolute inset-0 rounded-2xl bg-white/20 scale-0 group-hover:scale-150 transition-transform duration-700 ease-out opacity-40 group-hover:opacity-100"></div>
