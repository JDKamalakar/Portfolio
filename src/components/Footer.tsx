    ...
    <div className="bg-gray-900 dark:bg-black py-12 px-6 relative">
      ...
      <button
        ...
        className={`fixed bottom-8 right-8 p-4 text-white rounded-2xl shadow-2xl hover:shadow-3xl transition-all duration-500 ease-out group z-50
          backdrop-blur-lg                                   /* Increased blur for better separation */
          border-2 border-blue-400/50 dark:border-blue-600/50 /* Stronger, semi-transparent border */
          bg-gradient-to-br from-blue-600/30 to-indigo-700/30 /* Darker, more prominent gradient */
          hover:bg-gradient-to-br hover:from-blue-500/50 hover:to-indigo-600/50 /* Even more opaque on hover */
      ...
      >
        ...
        {/* Inner glow effect for hover, adapted for visibility */}
        ...
        <div className="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400 to-indigo-500 blur-xl opacity-0 group-hover:opacity-60 transition-opacity duration-500 -z-10 scale-150"></div>
      </button>
    </div>
  );
};
