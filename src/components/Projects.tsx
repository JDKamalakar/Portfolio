...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-1/4 right-0 w-8 h-8 bg-cyan-400/20 dark:bg-cyan-600/15 rounded-full blur-sm" 
           style={{ 
             animation: 'slideLeft 12s linear infinite',
             animationDelay: '3s'
           }}></div>
      <div className="absolute top-3/5 left-1/2 w-4 h-4 bg-indigo-400/20 dark:bg-indigo-600/15 rounded-full blur-sm" 
           style={{ 
                ...
                <div className="px-8 pb-6">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {project.technologies.map((tech, i) => (
                      <span
                        key={i}
                        className="px-4 py-2 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-lg text-sm font-medium hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer backdrop-blur-sm"
                ...
                <div className="p-8 pt-0 mt-auto">
                  <div className="flex gap-4">
                    <a
                      ...
                      className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-xl hover:shadow-lg hover:scale-105 transition-all duration-300 group/btn flex-1 justify-center backdrop-blur-sm"
                      onClick={(e) => e.stopPropagation()}
                    >
                    ...
                    <a
                      ...
                      className={`flex items-center gap-2 px-6 py-3 border-2 rounded-xl transition-all duration-300 hover:scale-105 group/btn flex-1 justify-center backdrop-blur-sm ${
                        hasDemoLink
