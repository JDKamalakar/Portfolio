  ...
  const themePopoverOptions = [
    {
      ...
      // MODIFIED: Added a static shadow for light mode separation
      hoverGlowClass: 'shadow-md shadow-blue-500/20 hover:shadow-lg hover:shadow-blue-500/40 dark:shadow-[0_0_8px_rgba(59,130,246,0.2)] dark:hover:shadow-[0_0_12px_rgba(59,130,246,0.4)]'
    },
    {
      label: 'Light',
      ...
      // MODIFIED: Added a static shadow for light mode separation
      hoverGlowClass: 'shadow-md shadow-yellow-500/20 hover:shadow-lg hover:shadow-yellow-500/40 dark:shadow-[0_0_8px_rgba(234,179,8,0.2)] dark:hover:shadow-[0_0_12px_rgba(234,179,8,0.4)]'
    },
    {
      label: 'Dark',
      value: 'dark' as const,
