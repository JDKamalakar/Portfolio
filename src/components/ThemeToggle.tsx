  ...
  const themePopoverOptions = [
    {
      ...
      // MODIFIED: Increased static glow opacity in light and dark modes
      hoverGlowClass: 'shadow-md shadow-blue-500/30 hover:shadow-lg hover:shadow-blue-500/40 dark:shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:hover:shadow-[0_0_12px_rgba(59,130,246,0.4)]'
    },
    {
      label: 'Light',
      ...
      // MODIFIED: Increased static glow opacity in light and dark modes
      hoverGlowClass: 'shadow-md shadow-yellow-500/30 hover:shadow-lg hover:shadow-yellow-500/40 dark:shadow-[0_0_8px_rgba(234,179,8,0.3)] dark:hover:shadow-[0_0_12px_rgba(234,179,8,0.4)]'
    },
    {
      label: 'Dark',
      value: 'dark' as const,
