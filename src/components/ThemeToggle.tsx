  ...
  const themePopoverOptions = [
    {
      ...
      // MODIFIED: Replaced shadow-md with a radial glow for light mode to match dark mode
      hoverGlowClass: 'shadow-[0_0_8px_rgba(59,130,246,0.3)] hover:shadow-[0_0_12px_rgba(59,130,246,0.4)] dark:shadow-[0_0_8px_rgba(59,130,246,0.3)] dark:hover:shadow-[0_0_12px_rgba(59,130,246,0.4)]'
    },
    {
      label: 'Light',
      ...
      // MODIFIED: Replaced shadow-md with a radial glow for light mode to match dark mode
      hoverGlowClass: 'shadow-[0_0_8px_rgba(234,179,8,0.3)] hover:shadow-[0_0_12px_rgba(234,179,8,0.4)] dark:shadow-[0_0_8px_rgba(234,179,8,0.3)] dark:hover:shadow-[0_0_12px_rgba(234,179,8,0.4)]'
    },
    {
      label: 'Dark',
      value: 'dark' as const,
