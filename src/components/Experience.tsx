...
const Experience = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-blue-200/30 via-cyan-200/20 to-blue-300/30 dark:from-blue-900/20 dark:via-cyan-900/15 dark:to-blue-800/20 rounded-full blur-3xl transition-all duration-1000 animate-pulse"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-br from-purple-200/30 via-pink-200/20 to-purple-300/30 dark:from-purple-900/20 dark:via-pink-900/15 dark:to-purple-800/20 rounded-full blur-3xl transition-all duration-1000 animate-pulse delay-1000"></div>
      
      {/* Floating animated orbs */}
      <div className="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-br from-indigo-300/25 to-blue-400/25 dark:from-indigo-800/15 dark:to-blue-900/15 rounded-full blur-2xl animate-bounce delay-700"></div>
      <div className="absolute bottom-1/4 right-1/4 w-24 h-24 bg-gradient-to-br from-violet-300/25 to-purple-400/25 dark:from-violet-800/15 dark:to-purple-900/15 rounded-full blur-2xl animate-bounce delay-1200"></div>
