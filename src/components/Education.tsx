              ...
              {education.map((edu, index) => {
                ...
                return (
                  <div
                    ...
                    className={`backdrop-blur-sm bg-white/80 dark:bg-gray-800/80 rounded-xl shadow-lg border border-white/20 dark:border-gray-700/20 transition-all duration-500 ${hasInstitution ? 'cursor-pointer' : 'cursor-default'} group overflow-hidden ${
                      isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
                    } ${isExpanded ? 'scale-[1.02] shadow-2xl' : 'hover:scale-[1.02]'} hover:shadow-[0_0_25px_rgba(234,179,8,0.5)] dark:hover:shadow-[0_0_25px_rgba(59,130,246,0.5)]`}
