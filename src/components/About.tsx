    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`backdrop-blur-xl bg-white/20 dark:bg-gray-800/20 p-8 rounded-lg shadow-2xl border border-white/20 dark:border-gray-700/20 hover:shadow-3xl hover:scale-[1.02] transition-all duration-500 group ${hasMoreContent ? 'cursor-pointer' : 'cursor-default'} ${
            ...
            <div className="backdrop-blur-xl bg-white/20 dark:bg-gray-800/20 p-6 rounded-xl shadow-2xl border border-white/20 dark:border-gray-700/20 hover:shadow-3xl hover:scale-[1.02] hover:bg-white/30 dark:hover:bg-gray-800/30 transition-all duration-300 group">
              ...
              <div className="flex flex-wrap gap-2">
                {about.languages.map((lang, index) => (
                  <span 
                    key={lang} 
                    className="px-3 py-1 bg-gradient-to-r from-blue-500 to-cyan-600 text-white rounded-lg text-sm hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer backdrop-blur-sm"
                  ...
                  if (link) {
                    return (
                      <a
                        ...
                        className="px-3 py-1 bg-gradient-to-r from-cyan-500 to-indigo-600 text-white rounded-lg text-sm hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer backdrop-blur-sm"
                        style={{ animationDelay: `${index * 50}ms` }}
                      >
                        {hobby}
                      </a>
