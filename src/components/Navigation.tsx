              ...
              <button
                ...
                className={`group relative p-3 rounded-xl transition-all duration-500 ease-out hover:scale-110 block w-full mb-2 last:mb-0 transform ${
                  activeSection === item.id
                    ...
                    // MODIFIED: Increased opacity and blur of the blue glow
                    : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-white/30 dark:hover:bg-gray-700/30 hover:shadow-[0px_10px_20px_-10px_rgba(234,179,8,0.5)] dark:hover:shadow-[0px_10px_25px_-10px_rgba(59,130,246,0.6)]'
                }`}
                title={item.label}
              >
                <Icon
                ...
                <button
                  ...
                  className={`flex items-center gap-3 w-full p-3 rounded-xl transition-all duration-300 hover:scale-105 mb-2 transform backdrop-blur-sm group ${
                    activeSection === item.id
                      ...
                      // MODIFIED: Increased opacity and blur of the blue glow
                      : 'text-gray-700 dark:text-gray-300 hover:bg-gray-100/30 dark:hover:bg-gray-800/30 hover:shadow-[0px_10px_20px_-10px_rgba(234,179,8,0.5)] dark:hover:shadow-[0px_10px_25px_-10px_rgba(59,130,246,0.6)]'
                  }`}
                  style={{
...
export default Navigation;3333