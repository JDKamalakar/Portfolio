              ...
              <button
                ...
                className={`group relative p-3 rounded-xl transition-all duration-500 ease-out hover:scale-110 block w-full mb-2 last:mb-0 transform ${
                  activeSection === item.id
                    ...
                    // MODIFIED: Changed hover background to match the glow color
                    : 'text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-yellow-500/20 dark:hover:bg-blue-500/20 hover:shadow-[0_0_16px_rgba(234,179,8,0.5)] dark:hover:shadow-[0_0_25px_rgba(59,130,246,0.6)]'
                }`}
                title={item.label}
              >
                <Icon
                ...
                <button
                  ...
                  className={`flex items-center gap-3 w-full p-3 rounded-xl transition-all duration-300 hover:scale-105 mb-2 transform backdrop-blur-sm group ${
                    activeSection === item.id
                      ...
                      // MODIFIED: Changed hover background to match the glow color
                      : 'text-gray-700 dark:text-gray-300 hover:bg-yellow-500/20 dark:hover:bg-blue-500/20 hover:shadow-[0_0_16px_rgba(234,179,8,0.5)] dark:hover:shadow-[0_0_25px_rgba(59,130,246,0.6)]'
                  }`}
                  style={{
